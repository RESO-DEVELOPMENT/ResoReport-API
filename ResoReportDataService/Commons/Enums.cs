...
namespace ResoReportDataService.Commons
{
    ...
    {
        [Display(Name = "Hiển thị trực tiếp")]
        Foryou = 1,
        [Display(Name = "Hiển thị popup")]
        Popup = 3
    }
    ...
    public enum RoleTypeEnum
    {
        ...
        ShiftBrowser = 16,
        [Display(Name = "Xem báo cáo thương hiệu mobile")]
        BrandReportViewerMobile = 17,
        [Display(Name = "Xem báo cáo cửa hàng mobile")]
        StoreReportViewerMobile = 18,
        [Display(Name = "Quản lý khu vực")]
        AreaManager = 19,
        [Display(Name = "Quản lý ca làm việc")]
        ShiftManager = 20,
    }
    ...
    public enum PromotionPublisherEnum
    {
        [Display(Name = "Passio")]
        Passio = 0,
        [Display(Name = "Meete")]
    ...
    public enum PayrollDetailType
    {
        [Display(Name = "Salary")]
        Salary = 0,
        [Display(Name = "TotalMonth")]
        TotalMonth = 1,
        [Display(Name = "TotalDelivery")]
        TotalDelivery = 2,
    }
    ...
    public enum B2BProductStatusEnum
    {
